...
import 'package:chef/views/suggestions.dart';

class ShoppingList extends StatefulWidget {
  ShoppingList({required Key key, required this.title}) : super(key: key);
              ...
              child: Container(
                  ...
                  child: TypeAheadField(
                    ...
                    itemBuilder: (context, suggestion) {
                      return ListTile(
                        title: Text(jsonEncode(suggestion)),
                      );
                    },
                    transitionBuilder:
                    ...
                    onSuggestionSelected: (suggestion) {
                      inputController.text = jsonEncode(suggestion);
                      _addItem();
